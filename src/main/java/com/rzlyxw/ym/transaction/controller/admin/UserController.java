package com.rzlyxw.ym.transaction.controller.admin;
...
public class UserController {
    ...
    @GetMapping("page")
    @ResponseBody
    public PageInfo<YmUser> pageInfo(HttpServletRequest request, YmUser user){
        ...
        PageInfo<YmUser> pageInfo = userService.page(draw,start,length,user);
        return pageInfo;
    }
     ...
     */
    @PostMapping("save")
    public String save(YmUser user){
    ...
    public String update(Long id, Model model){
        YmUser user = userService.getById(id);
